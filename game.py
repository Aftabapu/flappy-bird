...
def mainGame():
    ...
    playerFlapAccv = -8  # while flapping
...
if __name__ == "__main__":
    ...
    pygame.display.set_caption('Flappy Bird by CodeWith Aftab Apu')
    ...
    GAME_SPRITES['message'] = pygame.image.load('img/background.png').convert_alpha()
    ...
    # Game sounds
    GAME_SOUNDS['a'] = pygame.mixer.Sound('img/sound/a.wav')
    GAME_SOUNDS['a'] = pygame.mixer.Sound('img/sound/a.wav')
    GAME_SOUNDS['a'] = pygame.mixer.Sound('img/sound/a.wav')
    GAME_SOUNDS['a'] = pygame.mixer.Sound('img/sound/a.wav')
    GAME_SOUNDS['b'] = pygame.mixer.Sound('img/sound/b.wav')
